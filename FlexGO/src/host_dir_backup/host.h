...
extern aligned_vector<WT_TYPE> GCN_convs_root_emb_weight_GIN_node_mlp_2_bias_fixed;
extern aligned_vector<WT_TYPE> GIN_node_mlp_2_weight_fixed;
extern aligned_vector<WT_TYPE> PNA_node_conv_weight_fixed;

extern aligned_vector<WT_TYPE> bn_weight_PNA_graph_mlp_1_weight_fixed;
extern aligned_vector<WT_TYPE> bn_bias_PNA_graph_mlp_1_bias_fixed;
extern aligned_vector<WT_TYPE> bn_mean_PNA_graph_mlp_2_weight_fixed;
extern aligned_vector<WT_TYPE> bn_sqrt_var_PNA_graph_mlp_2_bias_fixed;
extern aligned_vector<WT_TYPE> graph_pred_PNA_graph_mlp_3_weight_fixed;
extern aligned_vector<WT_TYPE> graph_pred_PNA_graph_mlp_3_bias_fixed;
